...
echo "Clover Dual Boot Install Script for SteamOS, Bazzite and CachyOS by ryanrudolf"
...
then
    ...
    echo "Script is only tested on a Steam Deck or Legion Go S running on SteamOS / Bazzite / CachyOS."
    exit
fi
...
case $OS in
    ...
    CachyOS)
        echo "Making final configuration for $OS."
        # Set CachyOS as default boot in Clover config
...
echo "Desktop icon for Clover Toolbox has been created!"
